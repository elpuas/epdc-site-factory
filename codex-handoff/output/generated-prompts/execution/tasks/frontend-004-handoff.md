...
- Handoff ID: `generated-prompts--execution--tasks--frontend-004`
- Source prompt: `generated-prompts/execution/tasks/frontend-004.md`
- Category: `frontend`
...
- Implementation goal: Define the frontend work for the appointment request form with service-interest selection, visible request actions on conversion pages, and a persistent mobile click-to-call experience.
...
Execute task `frontend-appointment-form-and-mobile-cta`: Plan appointment request form and mobile conversion actions. Define the frontend work for the appointment request form with service-interest selection, visible request actions on conversion pages, and a persistent mobile click-to-call experience. Work only inside `projects/harbor-point-dental-studio` and only touch files declared in `allowedFiles`. Produce the outputs listed in the Expected Output section for this task.
