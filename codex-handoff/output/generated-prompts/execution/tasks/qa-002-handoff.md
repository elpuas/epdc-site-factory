...
- Handoff ID: `generated-prompts--execution--tasks--qa-002`
- Source prompt: `generated-prompts/execution/tasks/qa-002.md`
- Category: `qa`
...
- Allowed files: `["projects/harbor-point-dental-studio/src/layouts/BaseLayout.astro","projects/harbor-point-dental-studio/src/components/site/Header.astro","projects/harbor-point-dental-studio/src/components/site/Footer.astro","projects/harbor-point-dental-studio/src/data/site.ts","projects/harbor-point-dental-studio/src/pages/index.astro","projects/harbor-point-dental-studio/src/pages/contact.astro","projects/harbor-point-dental-studio/src/pages/services.astro"]`
...
- Implementation goal: Define the QA review needed to confirm appointment actions are visible on desktop and mobile and that practice name, phone number, address, and office hours remain consistent across key pages.
...
Execute task `qa-conversion-and-consistency-review`: Plan QA checks for conversion visibility and contact consistency. Define the QA review needed to confirm appointment actions are visible on desktop and mobile and that practice name, phone number, address, and office hours remain consistent across key pages. Work only inside `projects/harbor-point-dental-studio` and only touch files declared in `allowedFiles`. Produce the outputs listed in the Expected Output section for this task.
