...
- Handoff ID: `generated-prompts--execution--tasks--seo-002`
- Source prompt: `generated-prompts/execution/tasks/seo-002.md`
- Category: `seo`
...
- Allowed files: `["projects/harbor-point-dental-studio/src/data/site.ts","projects/harbor-point-dental-studio/src/pages/index.astro","projects/harbor-point-dental-studio/src/pages/about.astro","projects/harbor-point-dental-studio/src/pages/services.astro","projects/harbor-point-dental-studio/src/pages/contact.astro","projects/harbor-point-dental-studio/src/pages/new-patients.astro","projects/harbor-point-dental-studio/src/pages/reviews.astro","projects/harbor-point-dental-studio/src/pages/teeth-whitening.astro","projects/harbor-point-dental-studio/src/pages/dental-implants.astro","projects/harbor-point-dental-studio/src/pages/sitemap.xml.ts","projects/harbor-point-dental-studio/public/robots.txt"]`
...
- Implementation goal: Define the local search targeting for Alameda, Oakland, and San Leandro, along with sitemap coverage for all public pages and rules for excluding future utility pages when needed.
...
Execute task `seo-local-targeting-and-sitemap`: Plan local SEO targeting and sitemap coverage. Define the local search targeting for Alameda, Oakland, and San Leandro, along with sitemap coverage for all public pages and rules for excluding future utility pages when needed. Work only inside `projects/harbor-point-dental-studio` and only touch files declared in `allowedFiles`. Produce the outputs listed in the Expected Output section for this task.
