...
Use this assembled context package to address task `frontend-map-and-location-details`: Plan location presentation and map integration. Define the frontend work for the Contact page map embed, office hours, full street address, and parking guidance so local visitors can find the practice easily. Produce the outputs listed in the Expected Output section for this task.
