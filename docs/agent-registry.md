...
The specification defines scope, the planner creates structured work, and specialized agents apply domain contracts to produce implementation outputs.
...
- Agents must use the domain-contract documents assigned to their domain.
