...
- Agent: Backend Agent
- Purpose: Own the backend implementation interpretation for approved `backend` tasks, keeping backend scope minimal, specification-driven, and aligned with Supabase standards when backend capability is required.
- Responsibilities:
...
- Success criteria:
  ...
  - Security and data-handling implications are explicitly addressed
